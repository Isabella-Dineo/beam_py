...
doDm = True
snrfig, snrax = plt.subplots() # will use to plot snr vs dm curve
while doDm:
#=======================================
...
#==================================================================
    ...
    if any(i < snr_threshold for i in SN):
        ...
        snrax.plot(dm_range, peaks_of_average)
        snrax.set_title('Best dm trial')
        snrax.set_xlabel('delta dm (pc cm^-3)')
